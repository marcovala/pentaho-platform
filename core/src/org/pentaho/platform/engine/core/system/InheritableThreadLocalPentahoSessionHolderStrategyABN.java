 ...
 * @author mlowery
 */
public class InheritableThreadLocalPentahoSessionHolderStrategyABN implements IPentahoSessionHolderStrategy {

  // ~ Static fields/initializers
  // ======================================================================================

  private static final Log logger = LogFactory.getLog( InheritableThreadLocalPentahoSessionHolderStrategyABN.class );
  ...
  public InheritableThreadLocalPentahoSessionHolderStrategyABN() {
    super();
  }
  ...
  public void removeSession() {
    ...
    if ( sess != null ) {
      ...
      logger.debug("InheritableThreadLocalPentahoSessionHolderStrategyABN");
